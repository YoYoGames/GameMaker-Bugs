...
layout: home
---
# 2024.1300 - Current Version: IDE 785/Runtime 790

Download Links: [Windows](https://gms.yoyogames.com/GameMaker-Installer-2024.1300.0.785.exe) - [macOS](https://gms.yoyogames.com/GameMaker-2024.1300.0.785.pkg) - [Ubuntu Beta](https://gms.yoyogames.com/GameMaker-Beta-2024.1300.0.785.deb)

{% include important.html content="GMRT Users: Please be aware these 2024.1300/2024.13 releases are incompatible with GMRT 0.15.0 and older - you will need to install newer 0.16.0+ packages in Package Manager before any projects will build using GMRT" %}

{% include important.html content="Ubuntu IDE Users: Please be aware that as of Beta 5 below, the Ubuntu IDE releases are incompatible with Ubuntu 22 LTS - you will need to use Ubuntu 24 LTS in order to use the later Betas here and all future releases" %}


<br>


## Beta 8 - [IDE 785/Runtime 790 Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue+is%3Aclosed+milestone%3A2024.13+closed%3A2025-03-20..2025-03-26)  (Mar 27, 2025)
...
- **Removed More Marketplace Integration Functionality**
...
- **Other Runtime Changes To Be Aware Of**
    - Building Projects: Can't compile if a room Instance shares its name with a UI Layer or FlexPanel node [#9909](https://github.com/YoYoGames/GameMaker-Bugs/issues/9909)
    - Building Projects: [YYC] Projects using prefabs/filters/effects could fail due to too-long filepath lengths in recent 2024.1300 builds
    - In-Game: Calling a function with a parameter named the same as the Script asset in which it is defined throws an error [#9897](https://github.com/YoYoGames/GameMaker-Bugs/issues/9897)
    ...
    - In-Game: instance_destroy() inside an object on a flexpanel causes a silent crash in 2024.1300 Beta 6 [#9905](https://github.com/YoYoGames/GameMaker-Bugs/issues/9905)
...
## Beta 7 - [IDE 781/Runtime 786 Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue+is%3Aclosed+milestone%3A2024.13+closed%3A2025-03-13..2025-03-19)  (Mar 20, 2025)

- **UI Layers Changes/Fixes**
    - UI Layers: Copy pasting from an instance or asset layer to a UI layer resets the position of the pasted elements [#9813](https://github.com/YoYoGames/GameMaker-Bugs/issues/9813)
    - UI Layers: Text and Instance elements have redundant tiling controls which should be removed [#9775](https://github.com/YoYoGames/GameMaker-Bugs/issues/9775)
    - UI Layers: Runtime layout does not apply Room Editor rotation values correctly when positioning instances [#9761](https://github.com/YoYoGames/GameMaker-Bugs/issues/9761)
    - In-Game: UI Layer text elements stretched and maintaining aspect ratio fit the containing panel rather than overflowing [#9839](https://github.com/YoYoGames/GameMaker-Bugs/issues/9839)
    - In-Game: Anchor value/initial position is wrong for a UI Layer element at the centre of the room in the attached project [#9825](https://github.com/YoYoGames/GameMaker-Bugs/issues/9825)
    - UI Layers: Items in viewport layers cannot be clicked directly by mouse event if the camera has moved [#9758](https://github.com/YoYoGames/GameMaker-Bugs/issues/9758)
    - UI Layers: Disabling visibility in the Room Editor changes the draw order of elements in-game [#9749](https://github.com/YoYoGames/GameMaker-Bugs/issues/9749)
...
- **Other Runtime Changes To Be Aware Of**
    - Building Projects: Asset Compiler doesn't allow enum members to reference other enum members in 2024.1300 Beta 6 [#9824](https://github.com/YoYoGames/GameMaker-Bugs/issues/9824)
    - In-Game: Crash when accessing/modifying a function/constructor static variable from objects in 2024.1300 [#9659](https://github.com/YoYoGames/GameMaker-Bugs/issues/9659)
    - In-Game: Windy Woods template no longer playable due to layer_get_fx not finding the effect layer [#9886](https://github.com/YoYoGames/GameMaker-Bugs/issues/9886) (although note that the linked HTML5 fix is not in this version!)
    - In-Game: asset_get_tags() doesn't work with optional argument anymore in 2024.1300 Beta 6 [#9785](https://github.com/YoYoGames/GameMaker-Bugs/issues/9785) / In-Game: asset_get_tags() errors for "wrong number of arguments" in 2024.1300 Beta 6 [#9783](https://github.com/YoYoGames/GameMaker-Bugs/issues/9783)
...
## Beta 6 - [IDE 775/Runtime 781 Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue+is%3Aclosed+milestone%3A2024.13+closed%3A2025-03-06..2025-03-12)  (Mar 13, 2025)

- **UI Layers Changes/Fixes**
    - UI Layers: Allow layer_x and layer_y to work with UI layers [#9668](https://github.com/YoYoGames/GameMaker-Bugs/issues/9688)
    - UI Layers: Create events for instances on layers that target viewports are not fired in 2024.1300 Beta 5 [#9711](https://github.com/YoYoGames/GameMaker-Bugs/issues/9711)
    - UI Layers: Runtime layout does not apply Room Editor scaling values correctly when positioning instances [#9737](https://github.com/YoYoGames/GameMaker-Bugs/issues/9737)
    - UI Layers: Mouse Enter event performed on game start for some instances on UI layers [#9666](https://github.com/YoYoGames/GameMaker-Bugs/issues/9666)
    - UI Layers: Tiling a sprite asset in a flexpanel causes compile to fail [#9725](https://github.com/YoYoGames/GameMaker-Bugs/issues/9725)
    - UI Layers: Still laid out every frame even when non-visible [#9580](https://github.com/YoYoGames/GameMaker-Bugs/issues/9580)
    - UI Layers: "depth" affects draw order on a layer, add layer_get_type() and is_on_gui_layer() so this can be determined and avoided [#9626](https://github.com/YoYoGames/GameMaker-Bugs/issues/9626)
...
- **Prefab Assets - "UI Button With Code" Example Now Available**
    ...
    - If you have any problems where you're unable to drag this prefab into your rooms, please ensure you have also installed the "UI Panels  Glossy" prefab that was released last week
...
- **Code Editor 2 and Feather Fixes**
    ...
    - Feather: Match3 template gives a Language Services Error each time you create a project from it in Beta IDE v2024.1300.0.768 [#9653](https://github.com/YoYoGames/GameMaker-Bugs/issues/9653) / Code Editor 2: LSP failing in projects it did not fail in in previous beta [#9655](https://github.com/YoYoGames/GameMaker-Bugs/issues/9655)
    ...
    - Code Editor 2: Creating a JSDoc header displays information weirdly in 2024.1300 Beta 5 [#9692](https://github.com/YoYoGames/GameMaker-Bugs/issues/9692)

- **SVG Support Additions**
    - Building Projects: SVG sprites should not export an unwanted bitmap copy also [#9573](https://github.com/YoYoGames/GameMaker-Bugs/issues/9573)
    - SVGs: Warn on import if the incoming image contains unsupported features [#9572](https://github.com/YoYoGames/GameMaker-Bugs/issues/9572)
    - Sprite Editor: SVGs containing pure black colours import this as a silver/grey, passes incorrect result in-game also [#8126](https://github.com/YoYoGames/GameMaker-Bugs/issues/8126)
...
- **Other IDE Changes To Be Aware Of**
    ...
    - Texture Groups Editor: Undoes saved changes to texture group settings when opening the editor (note that you will need to fix any existing incorrect values manually one time, as this fix only prevents the issue happening from now on) [#9325](https://github.com/YoYoGames/GameMaker-Bugs/issues/9325)
