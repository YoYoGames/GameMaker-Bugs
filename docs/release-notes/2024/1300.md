...
> [!NOTE]
> We have added a selection of User Interface Prefab Assets that you can use for your projects and within UI Layers
> 
> <img src="https://github.com/user-attachments/assets/6d3e7f71-c3d8-4f4b-9e13-5e8b42027aae" alt="drawing" width="400"/> <img src="https://github.com/user-attachments/assets/1c689dd5-f176-46ee-83b4-7d0c191c7b97" alt="drawing" width="400"/>
>
> You can access these by installing the appropriate package from the Package Manager, then drag them out of the Prefab Library.
