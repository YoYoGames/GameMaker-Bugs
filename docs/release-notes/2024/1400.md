...
- **Creating New Projects No Longer Adds The Empty Default Folders**
    ...
    - This communicates more clearly to everyone new to GameMaker that you do not have to create all your sprites in the "Sprites" folder, all objects in the "Objects" folder, and so on...
...
- **Previewing Sounds In The IDE Is More Accurate**
    ...
    - This means your options can be heared during the preview inside the IDE and you no longer have to build your game in order to hear the difference after making a change
...
- **UI Layers Changes**
    ...
    - The Room Editor no longer updates your position coordinates when changing the anchor of an element in a flex panel (but a Preference has also been added to keep the old bahaviour if you want) [#9698](https://github.com/YoYoGames/GameMaker-Bugs/issues/9698)
...
- **Code Editor 2 Changes**
    - Lots of bugs have been fixed - especially do do with colouring, tooltips, and F1/MMB to open the correct target
...
- **Other Runtime Changes To Be Aware Of**
    ...
    - In-Game: [Ubuntu] 202.1300 RT 743 enumerates mice as gamepads [#9250](https://github.com/YoYoGames/GameMaker-Bugs/issues/9250)
