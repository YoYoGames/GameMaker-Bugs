...
{% include important.html content="GMRT Users: Please be aware these 2024.1400/2024.14 releases are incompatible with GMRT 0.16.5 and older - you will need to install the fortcoming 0.16.6+ packages in Package Manager before any projects will build using GMRT" %}
...
- **Deprecated `instance_change()`**
    ...
    - If your project uses this function you **will** need to tick this Game Option now, otherwise you will get a code error in-game that instance_change() could not be found
