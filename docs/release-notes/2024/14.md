...
{% include important.html content="The IDE updater in earlier releases will not update you to 2024.14 - you will need to download the installer using the links above and install the old-fashioned way." %}
...
- **Other IDE Changes To Be Aware Of**
    - Please note that this is only a small subset of the issues, and focuses on commonly-reported issues and those that might change how you use the editors, so check the milestone page for the full list if you were looking for a specific issue to be listed here
...
- **Spine Pre-Multiplied Alpha Control Functions Added**
