...
layout: home
---
# 2024.800 - Current Version: IDE 613/Runtime 636

Download Links: [Windows](https://gms.yoyogames.com/GameMaker-Installer-2024.800.0.613.exe) - [macOS](https://gms.yoyogames.com/GameMaker-2024.800.0.613.pkg) -  [Ubuntu Beta](https://gms.yoyogames.com/GameMaker-Beta-2024.800.0.613.deb)
...
- **IDE Featured Changes**
    - Debugger: Game no longer crashes when hitting a breakpoint inside path_point_adjust() in the attached project [#7237](https://github.com/YoYoGames/GameMaker-Bugs/issues/)
    - Room Editor: Editing inherited layers in a child room no longer causes the IDE to go unstable [#7246](https://github.com/YoYoGames/GameMaker-Bugs/issues/)
    - Room Editor: Deleting instances in the parent room will no longer corrupt them in its child [#7242](https://github.com/YoYoGames/GameMaker-Bugs/issues/)
    - Stability: Fixed a GM crash when checking OSVersion value during startup sequence on some machines [#7359](https://github.com/YoYoGames/GameMaker-Bugs/issues/)
    - Timeline Editor: GM no longer goes unstable when merging moments in 2024.800 Betas (although, we are aware that right now this will trigger an unexpected File Watcher dialog) [#10475](https://github.com/YoYoGames/GameMaker-Bugs/issues/)
    ...
    - UI/UX: [Mac IDE] Menubar interactions no longer become unreliable after opening the Source Control menu multiple times in an IDE session [#7192](https://github.com/YoYoGames/GameMaker-Bugs/issues/)

- **Runtime Featured Changes**
    - In-Game: Reverted the new behaviour introduced in earlier 2024.800 Betas of throwing code errors for bad audio indices [#7284](https://github.com/YoYoGames/GameMaker-Bugs/issues/)
    - In-Game: Incrementing a constructor's static variable directly via operators no longer gives an error [#7173](https://github.com/YoYoGames/GameMaker-Bugs/issues/)
    - In-Game: [Android] Rendering no longer fails (resulting in a black screen) when resuming a game after an interstitial ad [#7290](https://github.com/YoYoGames/GameMaker-Bugs/issues/)
    ...
    - In-Game: [Ubuntu] Projects no longer crash during startup in 2024.800 runtimes if the machine running the game does not already have the required-as-of-2024.8 "PulseAudio" package installed already [#7234](https://github.com/YoYoGames/GameMaker-Bugs/issues/)
