...
layout: home
---
# 2024.800 - Current Version: IDE 605/Runtime 628

Download Links: [Windows](https://gms.yoyogames.com/GameMaker-Installer-2024.800.0.605.exe) - [macOS](https://gms.yoyogames.com/GameMaker-2024.800.0.605.pkg) -  [Ubuntu Beta](https://gms.yoyogames.com/GameMaker-Beta-2024.800.0.605.deb)
...
- **IDE Featured Changes**
    ...
    - Inspector: [Objects] "Visible" and "Persistent" checkboxes were in a section called "Collision Mask", so this caused confusion - the section has now been renamed to "General Settings" and the 1 gadget that was actually to do with the collision mask now says this explicitly [#6645](https://github.com/YoYoGames/GameMaker-Bugs/issues/6645)
