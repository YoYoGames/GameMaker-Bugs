...
layout: home
---
# 2024.1400.4 - Current Version: IDE 1030/Runtime 1004

Download Links: [Windows](https://gms.yoyogames.com/GameMaker-Installer-2024.1400.4.1030.exe) - [macOS](https://gms.yoyogames.com/GameMaker-2024.1400.4.1030.pkg) - [Ubuntu Beta](https://gms.yoyogames.com/GameMaker-Beta-2024.1400.4.1030.deb)
...
## 2024.1400.4 Release (IDE 1030 / GMS2 RT 1004) - [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.4%20closed%3A2026-03-18..2026-03-23%20sort%3Aupdated-desc) (24/03/2026)
...
- Building Projects: [Switch] Extensions no longer fail to load [#14361](https://github.com/YoYoGames/GameMaker-Bugs/issues/14361)
...
- ProjectTool: All templates on the Start Page convert correctly again, after being accidentally broken for some templates in Beta release 7 [#14370](https://github.com/YoYoGames/GameMaker-Bugs/issues/14370)

<hr>
<br>

## 2024.1400.4 Release 7 (IDE 1023 / GMS2 RT 998) - [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.4%20closed%3A2026-03-12..2026-03-18%20sort%3Aupdated-desc) (19/03/2026)

{% include important.html content="We are aware there is a ProjectTool issue when creating new projects using some of the Start Page templates [#14370](https://github.com/YoYoGames/GameMaker-Bugs/issues/14370) - this will be fixed for the next release." %}
...
- In-Game: A further fix has been made for changing window size/state soon after an earlier request used to ignore the new request - so the window will now use the correct values [#12949](https://github.com/YoYoGames/GameMaker-Bugs/issues/12949)
...
- Manual Content: `flexpanel_create_node()` page no longer says the flexpanel creation struct is retained and can be used later on
...
## 2024.1400.4 Release 6 (IDE 1020 / GMS2 RT 996) - [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.4%20closed%3A2026-03-03..2026-03-12%20sort%3Aupdated-desc) (12/03/2026)
...
- Stability: [Ubuntu IDE] GM no longer hangs while idling after running python scripts to update localisation of external files [#14206](https://github.com/YoYoGames/GameMaker-Bugs/issues/14206)
...
- Docs Integration: [Mac IDE] Fixed that recent 2024.1400.4 beta IDEs were incorrectly opening the monthly manual [#14209](https://github.com/YoYoGames/GameMaker-Bugs/issues/14209)
...
- Room Editor: Fixed that cutting multiple Objects at once and pasting them to a different layer lost any instance creation code those Objects had [#13530](https://github.com/YoYoGames/GameMaker-Bugs/issues/13530)
...
- Startup: Restarting to apply Preferences changes no longer fails due to the process-killer changes in recent 2024.1400 Betas [#14213](https://github.com/YoYoGames/GameMaker-Bugs/issues/14213)
...
## 2024.1400.4 Release 5 (IDE 1011 / GMS2 RT 986) - [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.4%20closed%3A2026-02-24..2026-03-03%20sort%3Aupdated-desc) (03/03/2026)

### Crash/Stability Fixes

- **Stability: [Windows IDE] Renderer Updated To Stop GPU Crashes**
    - 2024.14 releases have shown an increase in "random" crashes due to GPU drivers being unable to resize swapchains or not responding to more commands - this release upgrades the renderer to a current version and so should more reliably support recent external changes in drivers/Windows
    - There are a large number of reports for this, so there's no way we could list all of them here, but we encourage as many people as possible to try this release if GM 2024.14 crashes often on your PC (especially if you know your older GM crashes when you do a specific, repeatable action)
...
- Source Control: [Ubuntu IDE] GM no longer crashes when Repo URL path check fails during cloning [#14131](https://github.com/YoYoGames/GameMaker-Bugs/issues/14131)
- Source Control: [Ubuntu IDE] GM no longer crashes sometimes when closing the OS file manager [#14133](https://github.com/YoYoGames/GameMaker-Bugs/issues/14133)
...
- UI/UX: [Mac IDE] Fixed cases where DPI could be wrong on old(er) Intel-based Macs, such as a 2019 Macbook Pro [#14097](https://github.com/YoYoGames/GameMaker-Bugs/issues/14097)
- UI/UX: [Ubuntu IDE] Fixed that opening the file explorer to load a project doesn't work on NixOS [#14146](https://github.com/YoYoGames/GameMaker-Bugs/issues/14146)

<br>

### In-Game Bugs Fixed

- **In-Game: [Windows] Fixed Lag Caused By Waitable Swapchains Being Enabled In Earlier 2024.14 Releases**
    - After discussions with the community helped determine the issue on some player's machines, we have now reverted a change to support "waitable" swapchains as part of earlier timings fixes
    - This should stop a number of cases where lag could be present between the visuals and input, or start/stop when toggling fullscreen, etc.
    - This includes the following two scenarios (and you can read some of the discussions on these issues)
       - In-Game: [Windows] Fixed that Alt+Tab usage introduces a lag to the game visuals if using 2024.14.1 RTs [#12980](https://github.com/YoYoGames/GameMaker-Bugs/issues/12980)
       - In-Game: [Windows] Fixed that huge amounts of input lag when Vsync is enabled and running game windowed on specific device, despite high fps [#14046](https://github.com/YoYoGames/GameMaker-Bugs/issues/14046)
    - Should you find that your PC still exhibits some form of lag in this release, please do use [the test project attached in the comments on #14046 above](https://github.com/user-attachments/files/25718363/LagTester.zip) and then file a new bug report saying which values cause/fix the issue on your PC (don't send us a different sample or your full game - use this premade test one)
...
## 2024.1400.4 Release 4 (IDE 1003 / GMS2 RT 981) - [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.4%20closed%3A2026-02-18..2026-02-24%20sort%3Aupdated-desc) (24/02/2026)
...
- **Room Editor: "Select from Any Layer" No Longer Turns Of Whenever Selecting Something On A Tile Or Path Layer [#6924](https://github.com/YoYoGames/GameMaker-Bugs/issues/6924)**
...
- Sprite Editor: Fixed that the eraser tool while a sprite is animating at 10FPS+ missed editing some frames [#14017](https://github.com/YoYoGames/GameMaker-Bugs/issues/14017)
...
- Building Projects: [Android YYC] Attached project no longer fails to build in RT 2024.1400.4.970 Betas [#14012](https://github.com/YoYoGames/GameMaker-Bugs/issues/14012)
- Building Projects: [Android, iOS] Attached project no longer fails with error regarding YYGML_CreateConstantArray if built with RT 2024.1400.4.954+ Betas [#13857](https://github.com/YoYoGames/GameMaker-Bugs/issues/13857)
...
## 2024.1400.4 Release 3 (IDE 999 / GMS2 RT 973) - [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.4%20closed%3A2026-02-11..2026-02-18%20sort%3Aupdated-desc) (18/02/2026)
...
## 2024.1400.4 Release 2 (IDE 991 / GMS2 RT 968) - [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.4%20closed%3A2026-02-04..2026-02-11%20sort%3Aupdated-desc) (11/02/2026)
...
## 2024.1400.4 Release 1 (IDE 986 / GMS2 RT 961) - [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.4%20closed%3A<2026-02-04%20sort%3Aupdated-desc) (04/02/2026)
