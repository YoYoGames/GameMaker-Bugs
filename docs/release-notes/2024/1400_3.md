...
layout: home
---
# 2024.1400.3 - Current Version: IDE 970/Runtime 943

Download Links: [Windows](https://gms.yoyogames.com/GameMaker-Installer-2024.1400.3.970.exe) - [macOS](https://gms.yoyogames.com/GameMaker-2024.1400.3.970.pkg) - [Ubuntu Beta](https://gms.yoyogames.com/GameMaker-Beta-2024.1400.3.970.deb)
...
## Beta 1 Update - IDE 970/Same Runtime 943  (Jan 15, 2026)

A quick IDE-only update containing just this one important fix for GM's installation files and the startup sequence (which caused crashes in IDE 967 on Windows PCs where Visual Studio has not been installed and set up for YYC development).

### IDE Bugs Fixed

- Startup: [Windows IDE] 2024.1400.3 Beta 1 relies on a debug version of FNA3D library being on the system [#13646](https://github.com/YoYoGames/GameMaker-Bugs/issues/13646)

<hr>
<br>

## Beta 1 - [IDE 967/Runtime 943 Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.3%20closed%3A<2025-12-13)  (Jan 14, 2026)
...
- **Prefabs: Modify A Prefab's Macros [#9781](https://github.com/YoYoGames/GameMaker-Bugs/issues/9781)**
...
- **In-Game: Misc Functions Now Implemented For More Targets**
    - [GX.games] `window_handle()` support [#13213](https://github.com/YoYoGames/GameMaker-Bugs/issues/13213)
    - [HTML5] `draw_tile()` is now defined [#13409](https://github.com/YoYoGames/GameMaker-Bugs/issues/13409)
...
- Image Editor: GM no longer crashes when trying to undo a sprite replacement to restore a previous source image [#13477](https://github.com/YoYoGames/GameMaker-Bugs/issues/13477)
...
- Asset Browser: [Ubuntu IDE] can now delete rooms which are using inheritance, deleting the parent folder no longer causes build errors [#13020](https://github.com/YoYoGames/GameMaker-Bugs/issues/13020)
- Audio Group Editor: Fixed that the incremental numbering scheme suddenly changes when reaching 20 [#12724](https://github.com/YoYoGames/GameMaker-Bugs/issues/12724)
- Building Projects: Resolved errors caused by a room instance's overwritten Variable Definitions not adequately clarify the problem location [#13202](https://github.com/YoYoGames/GameMaker-Bugs/issues/13202)
...
- Code Editor (Visual): Fixed that opening any project gives infinite Toolbox windows, after opening an old project which triggers this layout issue [#13570](https://github.com/YoYoGames/GameMaker-Bugs/issues/13570)
...
- In-Game: [HTML5] `wallpaper_set_config()` is now defined [#13396](https://github.com/YoYoGames/GameMaker-Bugs/issues/13396)
...
- In-Game: [GX.games YYC] Included Files and audio files for non-streamed Sounds are no longer misplaced in the package, now load correctly when run from the IDE [#13243](https://github.com/YoYoGames/GameMaker-Bugs/issues/13243)
...
- In-Game: Fixed exception_unhandled_handler() using finally causes a runtime exception if throw is called elsewhere [#13605](https://github.com/YoYoGames/GameMaker-Bugs/issues/13605)
...
- In-Game: [Windows] Fixed that my game runs very slowly on SOME computers if built with 2024.14.1 RTs [#13120](https://github.com/YoYoGames/GameMaker-Bugs/issues/13120)
...
- In-Game: [Windows] Fixed that in internal versions of 2024.1400.3 the game continues to track mouse position even when the game is not in focus [#13588](https://github.com/YoYoGames/GameMaker-Bugs/issues/13588)
...
- ProjectTool: Fixed that failure to rename the .yyp when using Save As sometimes still happened in 2024.14.2 [#13439](https://github.com/YoYoGames/GameMaker-Bugs/issues/13439)
