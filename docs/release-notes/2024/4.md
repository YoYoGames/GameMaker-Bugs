...
_It's worth also saying to avoid any confusion: 2024.2 does not contain the new code editor. If you want to try that, you must install a Beta release and then enable the code editor in Preferences._
