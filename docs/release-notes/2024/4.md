...
- **Redefine Keys and other misc UI/UX changes**
    ...
    - Room Editor: Project no longer gets corrupted when .yyp is renamed to something other than the internal project name [#2890](https://github.com/YoYoGames/GameMaker-Bugs/issues/2890)
