...
Download Links: [Windows](https://gms.yoyogames.com/GameMaker-Installer-2024.06.2.162.exe) - [macOS](https://gms.yoyogames.com/GameMaker-2024.06.2.162.pkg) -  [Ubuntu (Betas Only)](https://releases.gamemaker.io/release-notes/2024/600)

<br>

# .2 Update - [IDE v2024.6.2.162 Changes](https://github.com/YoYoGames/GameMaker-Bugs/milestone/17?closed=1)  (Jul 15, 2024)

_Note that the correct runtime for this update remains as Runtime v2024.6.1.208 - there is no .2 runtime. However, there is [a known issue that if you install this .6.2 IDE having not previously used .6.0 or .6.1, then the .6.1 runtime will not be downloaded automatically and set as active](https://github.com/YoYoGames/GameMaker-Bugs/issues/6915), so you do need to do this yourself in Preferences > Runtime Feeds > Master after installing this IDE, as otherwise builds will fail and various other tools will not work correctly!_
...
- **Hot Keys Asset Creation Crash**
    - Fixed that repetitively creating assets using the hot keys caused a crash if the previously created asset was not selected [#6678](https://github.com/YoYoGames/GameMaker-Bugs/issues/6678)

<br>

# .1 Update - [IDE 160/Runtime 208 Changes](https://github.com/YoYoGames/GameMaker-Bugs/milestone/16?closed=1)  (Jul 9, 2024)
...
# Original Release - Version 2024.6.0 (IDE 157/Runtime 205)  (Jul 2, 2024)
...
- [2024.6.2 IDE-only Update](https://github.com/YoYoGames/GameMaker-Bugs/milestone/17?closed=1)
