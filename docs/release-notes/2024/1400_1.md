...
- In-Game: Fixed that exceptions say "<unknown_object>" even when the object is known [#12405](https://github.com/YoYoGames/GameMaker-Bugs/issues/12405)
...
- In-Game: Fixed that sprites with "image_speed" of 0 play rapidly inside Sequences if the track speed is not 0 also [#12285](https://github.com/YoYoGames/GameMaker-Bugs/issues/12285)
...
- In-Game: [YYC] Fixed that constructor "self" can be wrong if static function name is precisely "create_array()" [#12522](https://github.com/YoYoGames/GameMaker-Bugs/issues/12522)
