...
- **Prefab Library**
    ...
    - When you duplicate something from a prefab collection into your project this _links_ the prefab's source project, so the files for the prefab itself are not added into your own project's source and instead the compiler knows to build what it needs out of _all_ projects and combines everything into your final game package
