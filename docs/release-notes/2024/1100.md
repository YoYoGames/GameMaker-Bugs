...
- **New Game Option For Stripping Unused Assets From Your Export Packages**
    ...
    - Note that this defaults to ON when creating/opening a new project in any "2024." IDE, as older IDEs do actually know about this functionality
    - For more on this new feature, see [#3597](https://github.com/YoYoGames/GameMaker-Bugs/issues/3597)
    - Be aware that there is a known issue with the Scribble asset, in that older versions of Scribble checked all font indexes and so if this setting is enabled Scribble will throw an error when it finds one is missing - you will need to change this code yourself or update your copy of Scribble ([#8198](https://github.com/YoYoGames/GameMaker-Bugs/issues/8198))
