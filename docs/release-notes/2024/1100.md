...
- **Prefab Library**
    ...
    - When you duplicate something from a prefab collection into your project this _copies_ the prefab into your project, so the source files for the prefab itself are added into your own project's source and breaks the link to the original prefab stopping it from using any later versions but alowing you to now edit the files in your project.
    - Open the Library inside your project by clicking "Windows > Prefab Library" and this will open the new bottom dock panel
    - Prefabs can then be downloaded (once) using its Package Manager integration and then added to any of your projects thereafter from your library
