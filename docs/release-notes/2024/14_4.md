...
layout: home
---
# 2024.14.4 - Current Version: IDE 221/Runtime 265

Download Links: [Windows](https://gms.yoyogames.com/GameMaker-Installer-2024.14.4.221.exe) - [macOS](https://gms.yoyogames.com/GameMaker-2024.14.4.221.pkg) - [Ubuntu (Betas Only)](https://releases.gamemaker.io/release-notes/2024/1400)
...
{% include important.html content="Earlier 2024.14 releases have shown an increase in "random" crashes due to GPU drivers being unable to resize swapchains or not responding to more commands - this .4 release upgrades the renderer to a current version and so should more reliably support recent external changes in drivers/Windows. There are a large number of existing bug reports for this, so there's no way we could list all of them below, but we encourage as many people as possible to try this release if earlier GM 2024.14.n releases crashed often on your PC (especially if you know your older GM crashes when you do a specific, repeatable action)." %}
