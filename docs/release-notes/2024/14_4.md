...
- **Release to address the following bugs**
    - In-Game: part_system_get_info's struct will have the particle type set to undefined if the system asset's emitter has a negative particle count [#14439](https://github.com/YoYoGames/GameMaker-Bugs/issues/14439)
	- In-Game: Game window doesn't appear [#14431](https://github.com/YoYoGames/GameMaker-Bugs/issues/14431)
	...
	- In-Game: [HTML5] RNG-Related Functions Cause HTML5 Crash [#14435](https://github.com/YoYoGames/GameMaker-Bugs/issues/14435)
	- In-Game: [iOS] Tap gestures are not registered/event called properly on XCode 26.4 [#1448](https://github.com/YoYoGames/GameMaker-Bugs/issues/14448)
	
<br>

## 2024.14.4 Release 1 (IDE 221 / GMS2 RT 265)
