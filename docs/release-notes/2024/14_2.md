...
layout: home
---
# 2024.14.2 - Current Version: IDE 213/Runtime 256

Download Links: [Windows](https://gms.yoyogames.com/GameMaker-Installer-2024.14.2.213.exe) - [macOS](https://gms.yoyogames.com/GameMaker-2024.14.2.213.pkg) - [Ubuntu (Betas Only)](https://releases.gamemaker.io/release-notes/2024/1400)
...
{% include important.html content="Please read these notes thoroughly, as there are prefab and also Windows in-game vsync settings changes that might require you to make changes in your projects." %}

<hr>
<br>

# Updated Release - 2024.14.2 (IDE 213/Runtime 256) [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.2%20closed%3A>2025-12-09)  (Dec 18, 2025)
...
# Original Release - 2024.14.2 (IDE 212/Runtime 255) [Changes](https://github.com/YoYoGames/GameMaker-Bugs/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A2024.14.2%20closed%3A<2025-12-09)  (Dec 11, 2025)
...
- **[Windows] Timing Fixes Means Games Now Better Obey Your Vsync and `game_set_speed()` Values [#12685](https://github.com/YoYoGames/GameMaker-Bugs/issues/12685)**
    - Be aware that as of this release if you want to ensure you do not have screen tearing in your games you **will** need to enable synchronisation in Game Options > Windows > Graphics
    - This change comes as a requirement of the fix to `game_set_speed()` for [#12493](https://github.com/YoYoGames/GameMaker-Bugs/issues/12493)
    - There is also a _partial_ fix in this release that in previous GM releases toggling vsync during gameplay also required a fullscreen toggle or to move the game window to a different monitor in order to reset the graphics swapchain before your updated vsync value would actually take effect - now, the vsync change will be applied immediately when you request it, as you'd expect [#13184](https://github.com/YoYoGames/GameMaker-Bugs/issues/13184)
    - Please be aware this is only a partial fix, as testing and the 2024.1400.2 Beta 3 release showed that the fix applied correctly on some users' PCs made no difference for others, and so the issue linked on the line above is still open for comments and samples
    - As you can see in the In-Game changelist below, there are a number of fixes for input lag, FPS issues, and also for games not starting on some PCs which can only support the old windowing method, so you should find that things are much smoother now (especially with the Game Option enabled)
    - Note that as of the .3 releases the default value for Game Options in new projects will be that vsync is enabled
    - {% include important.html content="Please do review your Vsync setting in Game Options and be advised it is recommended you turn this functionality on now" %}
