...
_If you have manipulated the the Code Editor 2 Theme in previous versions, be aware you may encounter the following issue [9048](https://github.com/YoYoGames/GameMaker-Bugs/issues/9048) where selected text is not shown as the highlight is fully opaque, should you encounter this, you will need to reset the theme. See linked issue comments for specific details._

_Audio beeps in IDE have been removed for MacIDE due to issue: [10022](https://github.com/YoYoGames/GameMaker-Bugs/issues/10022)._
