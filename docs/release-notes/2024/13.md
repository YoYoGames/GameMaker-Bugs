...
- **Optimised Calling Of Functions**
    ...
    - Note that this does require a change in how you need to code your functions which use inheritance and then later get overridden inside child objects (e.g, functionA calls functionB, and in your child object you override functionA) as you now need to add "self." before the parent functionA calls functionB
