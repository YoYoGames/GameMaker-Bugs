...
- **ProjectTool Updated**
    - A newer "2024.1300." version of ProjectTool was released during the beta period for this release - this IDE uses that version; however, you may need to modify Package Manager in order to use this newer version
