...
layout: home
---
# 2022.0.3 - Current Version: IDE 85/Runtime 99

Downloads: [Windows](https://gms.yoyogames.com/GameMaker-Installer-2022.0.3.85.exe) - [macOS](https://gms.yoyogames.com/GameMaker-2022.0.3.85.pkg)
...
# Changes In The Update .3 Release - IDE v2022.0.3.85  Runtime v2022.0.3.99 (Dec 3, 2024)

- **These 4 Fixes Only**
    - Building Projects: 2022.0.3 LTS runtime 99 now creates stub functions properly for disabled extensions (e.g., Steamworks) [#8486](https://github.com/YoYoGames/GameMaker-Bugs/issues/8486)
    - In-Game: [Windows] Fullscreen toggling now works correctly again in 2022.0.3 LTS runtime 99 [#8494](https://github.com/YoYoGames/GameMaker-Bugs/issues/8494)
    - In-Game: [Windows] game_change() and then Alt+Enter no longer causes the original game to be fullscreen also but only show a Taskbar button [#8538](https://github.com/YoYoGames/GameMaker-Bugs/issues/8538)
...
# Changes In The Original .3 Release - IDE v2022.0.3.83  Runtime v2022.0.3.98 (Nov 21, 2024)
